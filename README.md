...
Production-ready marketing site for **Asraf Tailors** (Next.js App Router, TypeScript, Tailwind CSS v4). Business copy, phone, address, map embed, pricing hints, and offers live in **`lib/site-config.ts`**—edit that file instead of hunting through components.
